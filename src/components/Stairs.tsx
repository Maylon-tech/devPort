...
const Stairs = () => {
  return (
    <>
     ...
     Each div will have the same animation defined by the stairsAnimatoin object. The 
     Delay for each div is calculated sinamically based on it's reversed index, creating a
